...
function ExternalUrlLink({ url }: { url: string }) {
  return (
    <a
      className="inline-flex max-w-full items-center gap-1 wrap-anywhere text-primary underline underline-offset-4 hover:text-primary/80 focus-visible:rounded-sm focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50"
      href={url}
      target="_blank"
